  <footer id="mastfooter">
    <div class="container">
      ...
      <div id="izquierda" class="col-md-4">
        <p>
          Powered by:
        </p>
        <nav>
          <ul>
            <li>
              <a href="https://es.wordpress.org/" target="_blank">Wordpress</a>
            </li>
            <li>
            ...
            <li>
              <a href="https://generatewp.com/" target="_blank">GenerateWP</a>
            </li>
          </ul>
        </nav>
      </div>
      ...
      <div id="centro" class="col-md-4">
        ...
        <p>
          <a href="https://github.com/4k1k0/ukyo" target="_blank">
            Código fuente
          </a>
        </p>
      </div>
